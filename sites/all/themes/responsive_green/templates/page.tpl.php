...
<script>(function(d, s, id) {
  ...
  js.src = "//connect.facebook.net/en_US/sdk.js#xfbml=1&appId=170269909683256&version=v2.0";
...
<div id="footer">
  ...
  <div class="footer_credit">
   ...
   <?php endif; ?>
    <div id="copyright">
     <p class="copyright"><?php print t('Copyright'); ?> &copy; <?php echo date("Y"); ?>, <?php print $site_name; ?>  - All contents in this site are solely the views of the authors meant purely for learning purposes and should not be taken as investment ideas</p> 
    <div class="clear"></div>
    </div>
  </div>
  </div>
